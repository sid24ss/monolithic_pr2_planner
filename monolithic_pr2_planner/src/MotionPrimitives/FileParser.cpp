...
bool MotionPrimitiveFileParser::parseArmMotionPrimitives(string filename,
    ...
    while (!file.eof()){
        ...
        if (right_arm) {
            motion[GraphStateElement::R_OBJ_X] = coord[0];
            motion[GraphStateElement::R_OBJ_Y] = coord[1];
            motion[GraphStateElement::R_OBJ_Z] = coord[2];
            motion[GraphStateElement::R_OBJ_ROLL] = coord[3];
            ...
            motion[GraphStateElement::L_OBJ_Z] = coord[2];
        ...
        for (int i=0; i < num_interm_steps; i++){
            ...
            if (right_arm) {
                g_step[GraphStateElement::R_OBJ_X] = step[0];
                g_step[GraphStateElement::R_OBJ_Y] = step[1];
                g_step[GraphStateElement::R_OBJ_Z] = step[2];
                g_step[GraphStateElement::R_OBJ_ROLL] = step[3];
                g_step[GraphStateElement::R_OBJ_PITCH] = step[4];
                g_step[GraphStateElement::R_OBJ_YAW] = step[5];
                g_step[GraphStateElement::R_FA] = step[6];
                g_step[GraphStateElement::L_FA] = step[7];
            } else {
                g_step[GraphStateElement::L_OBJ_X] = step[0];
                g_step[GraphStateElement::L_OBJ_Y] = step[1];
                g_step[GraphStateElement::L_OBJ_Z] = step[2];
                g_step[GraphStateElement::L_OBJ_ROLL] = step[3];
                g_step[GraphStateElement::L_OBJ_PITCH] = step[4];
                g_step[GraphStateElement::L_OBJ_YAW] = step[5];
                g_step[GraphStateElement::R_FA] = step[6];
                g_step[GraphStateElement::L_FA] = step[7];
            }

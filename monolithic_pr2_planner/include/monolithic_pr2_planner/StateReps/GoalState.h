...
namespace monolithic_pr2_planner {
    ...
    class GoalState {
        public:
            GoalState(){ };
            GoalState(DiscObjectState r_obj_goal, DiscObjectState l_obj_goal,
            ...
            DiscObjectState getRightObjectState() const { return m_r_goal_state;};
            DiscObjectState getLeftObjectState() const { return m_l_goal_state;};
        ...
        private:
            ...
            DiscObjectState m_l_goal_state;
            DiscObjectState m_r_goal_state;
